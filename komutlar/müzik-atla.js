...
.setDescription(`<a:hypesquad1:802800009778036796>  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setTitle("Puffy | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:hypesquad1:802800009778036796>  **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
