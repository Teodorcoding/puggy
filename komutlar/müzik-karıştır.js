...
.setColor(AloneDogru)
.setTitle("Puffy |  Karıştır")
.setDescription(`<a:hypesquad1:802800009778036796> | Müzik Kuyruğu, ${message.author} tarafından karıştırıldı.`) 
...
.setTitle("• Hata: 009 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:hypesquad1:802800009778036796> | Müzik kuyruğunu karıştırabilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
