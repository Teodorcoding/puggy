...
.setDescription(`<a:hypesquad1:802800009778036796> | Şu anda çalan müziği görebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor("#22BF41")
.setDescription(`<a:hypesquad1:802800009778036796>  | Şu Anda Oynatılan:\n\nMüziğin Adı: \n\`${calan.name}\`\n\nMüziği Yükleyen Kanal: \n\`${calan.author}\` \n\nMüziğin Linki: \n[Youtube'den dinlemek için tıkla!](${calan.url})`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
